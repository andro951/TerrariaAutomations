...
namespace TerrariaAutomations.Items {
	public class PlatinumBlockPlacer : BlockPlacer {
		...
		protected override int cooldown => new Tiles.PlatinumBlockPlacer().cooldown;
		protected override Func<int> createTile => ModContent.TileType<Tiles.PlatinumBlockPlacer>;
	}
}
